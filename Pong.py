...
wn = turtle.Screen()
wn.title("Pong by @TokyoEdTech Modified by @CooperR97")
wn.bgcolor("black")
...
while True:
    ...
    if (ball.xcor() < -340 and ball.xcor() > -350) and ((ball.ycor() < paddle_a.ycor() + 50 and ball.ycor() > paddle_a.ycor() - 50) and (ball.ycor() >= paddle_a.ycor() + 30 or ball.ycor() <= paddle_a.ycor() - 30)):
        ball.setx(-340)
        ball.dy *= 2
        ball.dx *= -1
